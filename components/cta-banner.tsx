...
const DEFAULT: HomeCtaBanner = {
  ...
  card2Title: '100% Authentic Brands',
  card2Body: 'Every single item in our catalog is sourced directly from verified brand manufacturers. We guarantee pristine expiration dates and 100% authenticity.',
