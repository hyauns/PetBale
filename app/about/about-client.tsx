...
const DEFAULTS = {
  ...
  heroSubtitle: 'Founded in 2025, PetBale is a US-based pet supply retailer operated by DOG BOWL BAKERY LLC. We carry premium dog and cat food, treats, flea & tick, litter, and more from 100+ trusted pet brands.',
  heroEmoji: '🐾',
  ...
  storyParagraph2: "That is why we started PetBale. We curate a 100+ brand catalog from leading US pet brands — Blue Buffalo, Purina, Royal Canin, Hill's Science Diet, Wellness, and more — and ship every order brand-new, sealed, and within shelf life directly from our US-based brand and distributor fulfillment partners. PetBale is a brand owned and operated by DOG BOWL BAKERY LLC, a Florida limited liability company registered at 3832 Fescue St, Clermont, FL 34714.",
