...
const DEFAULTS = {
  ...
  heroSubtitle: 'Founded in 2024, PetBale is the ultimate premium e-commerce pet store in the USA. We strive to provide pasture-raised, organic, and tox-free feeds for your beloved cats and dogs.',
  heroEmoji: '🐾',
  ...
  storyParagraph2: 'That is why we started PetBale. By bypassing standard wholesale brokers, we work directly with verified pasture-raised farms and organic mills across the United States. We ensure every single pack of dog raw-replicate bites, cat hydration salmon, and dust-free carbon clay litter is shipped fresh and secure.',
